...
export const HOMEPAGE_TEMPLATES: HomepageTemplateDefinition[] = [
  ...
  },
  {
    ...
    category: 'silver',
    name: '요양원 메디컬 안심상담형',
    description: '의료 연계, 시설 안내, 이용 비용, 지도와 전화 전환을 강조하는 요양원 랜딩페이지입니다.',
    defaultPalette: 'calm',
    calculatorPosition: 'none',
    pages: ['home'],
  },
  {
    ...
    category: 'silver',
    name: '요양병원 공식 홈페이지형',
    description: '병원 신뢰도, 진료안내, 의료진, 소식, 간병 문의를 갖춘 요양병원 멀티페이지 템플릿입니다.',
    defaultPalette: 'calm',
    calculatorPosition: 'none',
    pages: ['home', 'about', 'services', 'portfolio', 'faq', 'contact'],
  },
  {
    ...
    category: 'silver',
    name: '재가복지 방문요양 신청형',
    description: '방문요양, 등급신청, 지원금 안내, 전화상담과 서비스 신청을 강조하는 재가복지센터 템플릿입니다.',
    defaultPalette: 'calm',
    calculatorPosition: 'none',
    pages: ['home', 'about', 'services', 'portfolio', 'faq', 'contact'],
  },
