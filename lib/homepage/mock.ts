...
export function createHomepagePreviewPackage(
  ...
  return {
    site: {
      ...
      status: 'published',
      business_name: isSilverHomecare ? '무플재가복지센터' : isSilverHospital ? '무플 요양병원' : isSilverDaycare ? '무플 요양원' : isCleanDetail ? '클린홈 프로' : isCarenex ? '빌딩케어 프로' : isTech ? (isGeneral ? '테크노바 솔루션' : '클린테크 플랫폼') : isTemplateStudio ? '온사이트 템플릿' : isGeneral ? '온사이트 스튜디오' : isPremium ? '오브제 스튜디오' : '무플 클린',
      headline:
        isSilverHomecare
          ? '건강한 노후의 행복'
          : isSilverHospital
      ...
      phone: isSilverHomecare ? '00-000-0000' : isSilverHospital ? '055-000-0000' : isSilverDaycare ? '031-466-9979' : isCleanDetail ? '0000-0000' : isCarenex ? '0000-0000' : '010-1234-5678',
      kakao_url: 'https://pf.kakao.com/_demo',
      blog_url: 'https://blog.naver.com/demo',
      naver_place_url: null,
      instagram_url: null,
      logo_image_url: null,
      address: isSilverHomecare ? '강원특별자치도 원주시 무플로 00' : isSilverHospital ? '경남 창원시 마산합포구 무플로 00' : isSilverDaycare ? '경기 안양시 만안구 안양로 115, 2~6층' : isCleanDetail ? '서울특별시 강서구 공항대로 00' : isCarenex ? '서울특별시 영등포구 국제금융로 00' : isTech ? (isGeneral ? '서울 성동구 테크로 10' : '서울 강서구') : isTemplateStudio ? '서울 마포구' : isGeneral && isLocal ? '경기 성남시' : isLocal ? '서울 강서구' : '서울 강남구',
      service_area: isSilverHomecare
        ? '원주 방문요양 / 등급신청 / 가족 상담'
        : isSilverHospital
        ? '마산 / 창원 / 진해 / 함안 입원 상담'
        : isSilverDaycare
      ...
      business_hours: isSilverHomecare ? '방문요양 상담 09:00 - 18:00' : isSilverHospital ? '입원·간병 상담 09:00 - 18:00' : isSilverDaycare ? '상담 가능 시간 09:00 - 18:00' : isCarenex ? '평일 09:00 - 18:00' : '매일 08:00 - 20:00',
      seo_title: isSilverHomecare ? '무플재가복지센터 방문요양' : isSilverHospital ? '무플 요양병원 공식 홈페이지' : isSilverDaycare ? '무플 요양원' : isCleanDetail ? '클린홈 프로 입주청소' : isCarenex ? '빌딩케어 프로 건물 종합관리' : isTech ? (isGeneral ? '테크노바 솔루션 IT 기업 홈페이지' : '청소업 다크 프리미엄 홈페이지') : isTemplateStudio ? '현장업 홈페이지 템플릿 판매' : isGeneral ? '현장업 홈페이지 템플릿' : isPremium ? '오브제 스튜디오 인테리어' : '무플 클린 입주청소',
      seo_description: isSilverHomecare ? '방문요양 서비스 소개, 등급신청 절차, 본인부담금 안내와 전화 상담을 연결하는 재가복지센터 템플릿입니다.' : isSilverHospital ? '마산·창원·진해·함안 지역 입원 및 간병 상담을 위한 요양병원 공식 홈페이지 템플릿입니다.' : isSilverDaycare ? '안양 명학역 인근 메디컬 특화 프리미엄 요양원 무플 요양원 랜딩페이지 템플릿입니다.' : isCleanDetail ? '입주청소 서비스 신뢰 구축과 견적 전환을 위한 정보집약형 청소업 홈페이지 템플릿입니다.' : isCarenex ? '시설관리, 미화, 보안, 인재파견을 제공하는 건물 종합관리 기업 홈페이지 템플릿입니다.' : isTech ? (isGeneral ? '클라우드, AI, 빅데이터, 보안 솔루션을 제공하는 테크 기업 홈페이지 템플릿입니다.' : '입주청소와 이사청소 상담 전환을 위한 다크 테크 스타일 청소업 홈페이지 템플릿입니다.') : isTemplateStudio ? '현장업 사장님을 위한 홈페이지 템플릿과 제작 상품을 소개합니다.' : isGeneral ? '인테리어, 줄눈, 목공, 타일 등 현장업 홈페이지 템플릿입니다.' : isPremium ? '인테리어와 리모델링 포트폴리오를 확인하세요.' : '입주청소와 이사청소 예상 견적을 바로 확인하세요.',
      seo_keywords: isSilverHomecare ? ['재가복지센터', '방문요양', '등급신청', '본인부담금', '요양보호사'] : isSilverHospital ? ['요양병원', '마산요양병원', '창원요양병원', '간병문의', '보건복지부인증'] : isSilverDaycare ? ['무플요양원', '안양요양원', '평촌요양원', '명학역요양원', '프리미엄요양원'] : isCleanDetail ? ['입주청소', '이사청소', '청소후기', '청소견적', '청소범위'] : isCarenex ? ['건물관리', '시설관리', '미화관리', '보안관리', 'FM'] : isTech ? (isGeneral ? ['IT기업', '클라우드', 'AI', '빅데이터', '보안'] : ['청소업', '입주청소', '이사청소', '청소견적', '후기']) : isTemplateStudio ? ['현장업', '홈페이지 템플릿', '제작', '문의'] : isGeneral ? ['현장업', '시공', '인테리어', '줄눈', '목공'] : isPremium ? ['인테리어', '리모델링', '상업공간'] : ['입주청소', '이사청소', '청소견적'],
      seo_og_image_url: isSilverHomecare ? HOMEPAGE_SILVER_HOMECARE_IMAGES[0] : isSilverHospital ? HOMEPAGE_SILVER_HOSPITAL_IMAGES[0] : isSilverDaycare ? HOMEPAGE_SILVER_PREVIEW_IMAGES[0] : HOMEPAGE_PREVIEW_IMAGES[isPremium ? 12 : 0],
      seo_canonical_url: null,
      seo_noindex: false,
      seo_naver_verification: null,
      seo_google_verification: null,
      hero_image_url: isSilverHomecare ? HOMEPAGE_SILVER_HOMECARE_IMAGES[0] : isSilverHospital ? HOMEPAGE_SILVER_HOSPITAL_IMAGES[0] : isSilverDaycare ? HOMEPAGE_SILVER_PREVIEW_IMAGES[0] : HOMEPAGE_PREVIEW_IMAGES[isCleanDetail ? 4 : isCarenex ? 13 : isTech ? (isGeneral ? 13 : 4) : isPremium ? 12 : 0] || HOMEPAGE_PREVIEW_IMAGES[0],
      portfolio_title: isSilverHomecare
        ? '방문요양 서비스 안내'
        : isSilverHospital
        ? '의료진과 병원 소식'
        : isSilverDaycare
      ...
      footer_company_name: isSilverHomecare ? '무플재가복지센터' : isSilverHospital ? '무플 요양병원' : isSilverDaycare ? '무플 요양원' : isCleanDetail ? '클린홈 프로' : isCarenex ? '빌딩케어 프로' : isTech ? (isGeneral ? '테크노바 솔루션' : '클린테크 플랫폼') : isTemplateStudio ? '온사이트 템플릿' : isGeneral ? '온사이트 스튜디오' : isPremium ? '오브제 스튜디오' : '무플 클린',
      ...
      footer_address: isSilverHomecare ? '강원특별자치도 원주시 무플로 00' : isSilverHospital ? '경남 창원시 마산합포구 무플로 00' : isSilverDaycare ? '경기 안양시 만안구 안양로 115, 2~6층' : isCleanDetail ? '서울특별시 강서구 공항대로 00' : isCarenex ? '서울특별시 영등포구 국제금융로 00' : isTech ? (isGeneral ? '서울 성동구 테크로 10' : '서울 강서구 공항대로 00') : isTemplateStudio ? '서울 마포구 월드컵북로 00' : isGeneral ? '경기 성남시 분당구 00' : isLocal ? '서울 강서구 공항대로 00' : '서울 강남구 테헤란로 00',
      footer_phone: isSilverHomecare ? '00-000-0000' : isSilverHospital ? '055-000-0000' : isSilverDaycare ? '031-466-9979' : isCleanDetail ? '0000-0000' : isCarenex ? '0000-0000' : '010-1234-5678',
      footer_business_hours: isSilverHomecare ? '방문요양 상담 09:00 - 18:00' : isSilverHospital ? '입원·간병 상담 09:00 - 18:00' : isSilverDaycare ? '상담 가능 시간 09:00 - 18:00' : isCarenex ? '평일 09:00 - 18:00' : '매일 08:00 - 20:00',
      footer_privacy_url: null,
      footer_terms_url: null,
      footer_note: isSilverHomecare ? '방문요양 신청과 등급신청 상담은 전화로 빠르게 안내드립니다.' : isSilverHospital ? '입원 및 간병 상담은 전화 또는 문의 폼으로 접수할 수 있습니다.' : isSilverDaycare ? '상담 후 입소 조건과 이용 비용을 자세히 안내드립니다.' : '상담 후 현장 상황에 따라 최종 견적이 확정됩니다.',
      product_name: isSilverHomecare ? '재가복지센터 방문요양 홈페이지' : isSilverHospital ? '요양병원 공식 홈페이지' : isSilverDaycare ? '요양원 소개 랜딩페이지' : isCleanDetail ? '입주청소 정보형 서비스 페이지' : isCarenex ? '건물 종합관리 서비스' : isTech ? (isGeneral ? '통합 테크 솔루션' : '청소업 전환형 홈페이지') : isTemplateStudio ? '현장업 홈페이지 템플릿 제작' : previewName,
      product_price_note: isSilverHomecare ? '장기요양등급과 본인부담금 전화 상담' : isSilverHospital ? '입원·간병 상담 후 안내' : isSilverDaycare ? '1인실 250~257만원 / 2인실 190~197만원' : isCleanDetail ? '평형과 현장 상태에 따른 상담 견적' : isCarenex ? '관리 현장 규모별 맞춤 견적' : isTech ? (isGeneral ? '기업 맞춤 컨설팅 후 안내' : '청소업 템플릿 세팅 후 안내') : isTemplateStudio ? 'Basic / Standard / Premium 상품 운영' : '제작비와 월 관리비는 상담 후 안내',
      product_included_features: isSilverHomecare
    ...
    blogPosts: [
      {
        id: 'preview-post-1',
        site_id: `preview-${key}`,
        title: isSilverHomecare ? '방문요양 서비스 신청 안내' : isSilverHospital ? '보건복지부 의료기관 인증 안내' : isSilverDaycare ? '무플의원 연계 진료 안내' : isTemplateStudio ? '청소업 전시형 홈페이지 구성' : isGeneral ? '분당 상가 부분 시공 사례' : isPremium ? '논현동 라운지 리모델링' : isLocal ? '강서구 입주청소 현장' : '강남 입주청소 현장 다녀왔습니다',
        url: '#',
        summary: isSilverHomecare ? '전화 한 통으로 방문요양 가능 여부와 신청 절차를 안내합니다.' : isSilverHospital ? '환자 안전과 의료서비스 기준을 갖춘 인증 병원 정보를 안내합니다.' : isSilverDaycare ? '내과, 가정의학과, 피부과 연계 진료 구조를 보호자에게 쉽게 안내합니다.' : isTemplateStudio ? '회사소개, 서비스, 전후사진, 후기, 문의를 기본 흐름으로 보여주는 템플릿입니다.' : isGeneral ? '상담부터 마감까지 현장 조건에 맞춰 진행한 사례입니다.' : isPremium ? '조명과 마감재의 밀도를 높인 상업공간 프로젝트입니다.' : '신축 아파트 분진과 창틀 오염을 집중적으로 관리한 사례입니다.',
        thumbnail_url: isSilverHomecare ? HOMEPAGE_SILVER_HOMECARE_IMAGES[0] : isSilverHospital ? HOMEPAGE_SILVER_HOSPITAL_IMAGES[1] : isSilverDaycare ? HOMEPAGE_SILVER_PREVIEW_IMAGES[3] : HOMEPAGE_PREVIEW_IMAGES[isPremium ? 13 : 1],
      ...
      },
      {
        id: 'preview-post-2',
        site_id: `preview-${key}`,
        title: isSilverHomecare ? '장기요양 등급신청 절차' : isSilverHospital ? '사회복지 프로그램 운영 소식' : isSilverDaycare ? '1~2인실 생활 공간 안내' : isTemplateStudio ? '현장업 영업형 홈페이지 구성' : isGeneral ? '욕실 줄눈 보수 전후 비교' : isPremium ? '성수 쇼룸 공간 디자인' : isLocal ? '양천구 이사청소 전후 비교' : '송파 이사청소 전후 비교',
        url: '#',
        summary: isSilverHomecare ? '신청, 방문조사, 등급판정, 결과통보까지 보호자 눈높이에 맞춰 안내합니다.' : isSilverHospital ? '원예치료, 음악치료, 자원봉사 활동 등 환자 정서 지원 프로그램을 소개합니다.' : isSilverDaycare ? '프라이버시와 생활 편의를 고려한 1~2인실 중심의 공간 구성을 보여줍니다.' : isTemplateStudio ? '후기, 가격 기준, 빠른 상담 버튼을 앞쪽에 배치해 문의 전환을 목표로 합니다.' : isGeneral ? '사용 빈도가 높은 공간을 중심으로 시공 범위를 정리했습니다.' : isPremium ? '브랜드 분위기가 오래 남도록 동선과 조도를 정리했습니다.' : '주방 기름때와 욕실 물때를 중심으로 작업했습니다.',
        thumbnail_url: isSilverHomecare ? HOMEPAGE_SILVER_HOMECARE_IMAGES[3] : isSilverHospital ? HOMEPAGE_SILVER_HOSPITAL_IMAGES[4] : isSilverDaycare ? HOMEPAGE_SILVER_PREVIEW_IMAGES[2] : HOMEPAGE_PREVIEW_IMAGES[isPremium ? 10 : 2],
      ...
      },
      {
        id: 'preview-post-3',
        site_id: `preview-${key}`,
        title: isSilverHomecare ? '본인부담금 전화상담 안내' : isSilverHospital ? '자원봉사자 모집 안내' : isSilverDaycare ? '입소 상담과 이용 비용 안내' : isTemplateStudio ? '범용 현장업 홈페이지 구성' : isGeneral ? '맞춤 선반 제작 및 설치 사례' : isPremium ? '청담 주거공간 리모델링' : isLocal ? '마포구 상가청소 빠른 방문' : '분당 상가청소 정기관리 사례',
        url: '#',
        summary: isSilverHomecare ? '등급, 이용시간, 경감 여부에 따른 월 예상 부담금을 전화로 안내합니다.' : isSilverHospital ? '지역사회와 함께하는 병원 활동과 후원 소식을 공지합니다.' : isSilverDaycare ? '상담, 신청, 계약 흐름과 1인실/2인실 비용 정보를 한눈에 정리합니다.' : isTemplateStudio ? '줄눈, 목공, 인테리어, 방충망처럼 업종 문구만 바꿔 사용할 수 있습니다.' : isGeneral ? '공간 치수와 사용 목적에 맞춰 제작한 현장입니다.' : isPremium ? '불필요한 장식을 줄이고 소재의 깊이를 살린 현장입니다.' : '영업 전후 동선에 맞춰 빠르게 관리한 현장입니다.',
        thumbnail_url: isSilverHomecare ? HOMEPAGE_SILVER_HOMECARE_IMAGES[5] : isSilverHospital ? HOMEPAGE_SILVER_HOSPITAL_IMAGES[5] : isSilverDaycare ? HOMEPAGE_SILVER_PREVIEW_IMAGES[5] : HOMEPAGE_PREVIEW_IMAGES[isPremium ? 11 : 3],
        published_at: new Date(Date.now() - 172800000).toISOString(),
        is_visible: true,
        is_pinned: false,
      },
    ],
    mediaItems: (isSilverHomecare ? HOMEPAGE_SILVER_HOMECARE_IMAGES : isSilverHospital ? HOMEPAGE_SILVER_HOSPITAL_IMAGES : isSilverDaycare ? HOMEPAGE_SILVER_PREVIEW_IMAGES : HOMEPAGE_PREVIEW_IMAGES.slice(4, 10)).map((imageUrl, index) => ({
      id: `preview-media-${index + 1}`,
      site_id: `preview-${key}`,
      item_type: index < 3 ? 'after_photo' : 'portfolio',
      title: (isSilverHomecare
      ...
      description: isSilverHomecare ? '방문요양 상담과 가정 돌봄 서비스를 보호자가 이해하기 쉽게 보여줍니다.' : isSilverHospital ? '병원 신뢰도를 높이기 위해 외관, 병실, 진료 및 재활 환경을 사진으로 보여줍니다.' : isSilverDaycare ? '보호자가 안심할 수 있도록 요양원 시설과 케어 환경을 사진으로 보여줍니다.' : isTemplateStudio ? '템플릿 판매 홈페이지에서 강조할 수 있는 구성 화면입니다.' : isGeneral ? '현장에서 확인할 수 있는 시공 사진입니다.' : '현장에서 확인할 수 있는 청소 후 사진입니다.',
      image_url: imageUrl,
      before_image_url: null,
      after_image_url: null,
      alt_text: isSilverHomecare ? '재가복지센터 방문요양 사진' : isSilverHospital ? '요양병원 시설 사진' : isSilverDaycare ? '요양원 시설 사진' : isTemplateStudio ? '홈페이지 템플릿 화면' : isGeneral ? '현장 시공 사진' : '청소 후 현장 사진',
      sort_order: index,
      is_visible: true,
    })),
  }
