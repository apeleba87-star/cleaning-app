...
export default function CreateUserForm({ stores, companyId, onSuccess, onCancel }: CreateUserFormProps) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || '직원 초대에 실패했습니다.')
      }
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <h2 className="text-xl font-semibold mb-4">새 직원 초대</h2>
