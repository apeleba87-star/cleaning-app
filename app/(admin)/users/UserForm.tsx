...
export default function UserForm({ user, stores, onSuccess, onCancel }: UserFormProps) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || (user ? '수정에 실패했습니다.' : '추가에 실패했습니다.'))
      }
